/* Copyright (C) 2026 SkyNet Creator.
 *                                                All Rights Reserved.
 *
  ...
  public static synchronized boolean isAvailable() {
    if (!triedInit) {
      try {
        ...
        vlog.info("WARNING: Could not find SkyNet Helper JNI library.  If it is in a");
        ...
        vlog.info("WARNING: Could not initialize SkyNet Helper JNI library:");
