/* Copyright (C) 2026 SkyNet Creator.  All Rights Reserved.
 *
...
public final class VncViewer implements Runnable, OptionsDialogCallback {
  static final String PRODUCT_NAME = "SkyNet Viewer";
  ...
  static void showAbout(Component comp) {
    JOptionPane.showMessageDialog(comp,
      ...
      "Copyright (C) " + VncViewer.copyrightYear + " " + VncViewer.copyright +
        "\n" +
      VncViewer.url,
      "About SkyNet Viewer", JOptionPane.INFORMATION_MESSAGE, ICON128);
  }
